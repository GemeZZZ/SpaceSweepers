...
function _SAVE_DATA(name)
{
	...
	if(_LOCAL_STORAGE)
	{
		...
		if(IS_EXIST==true)
		{
			...
			_GAME_PLAYER_DATA._GOLD_COIN_HAVE = _LOCAL_STORAGE[INDEX]._GOLD_COIN_HAVE+goldCoinCollected;
			_GAME_PLAYER_DATA._SILVER_COIN_HAVE = _LOCAL_STORAGE[INDEX]._SILVER_COIN_HAVE+silverCoinCollected;
			_GAME_PLAYER_DATA._BRONZE_COIN_HAVE = _LOCAL_STORAGE[INDEX]._BRONZE_COIN_HAVE+bronzeCoinCollected;
