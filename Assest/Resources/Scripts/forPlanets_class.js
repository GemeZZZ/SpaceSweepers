class bgPlanets
{
	...
	draw()
	{
		...
		switch(this.planet)
		{
			...
			case 10:
			{
				c.drawImage(planet11,0-this.radius,0-this.radius,this.radius*2,this.radius*2);
			}
			break;

			case 11:
			{
				c.drawImage(planet12,0-this.radius,0-this.radius,this.radius*2,this.radius*2);
			}
			break;

			case 12:
			{
				c.drawImage(planet13,0-this.radius,0-this.radius,this.radius*2,this.radius*2);
			}
			break;

			case 13:
			{
				c.drawImage(planet14,0-this.radius,0-this.radius,this.radius*2,this.radius*2);
			}
			break;

			case 14:
			{
				c.drawImage(planet15,0-this.radius,0-this.radius,this.radius*2,this.radius*2);
			}
			break;

			case 15:
			{
				c.drawImage(planet16,0-this.radius,0-this.radius,this.radius*2,this.radius*2);
			}
			break;

			case 16:
			{
				c.drawImage(planet17,0-this.radius,0-this.radius,this.radius*2,this.radius*2);
			}
			break;

			case 17:
			{
				c.drawImage(planet18,0-this.radius,0-this.radius,this.radius*2,this.radius*2);
			}
			break;

			case 18:
			{
				c.drawImage(planet19,0-this.radius,0-this.radius,this.radius*2,this.radius*2);
			}
			break;

			case 19:
			{
				c.drawImage(planet20,0-this.radius,0-this.radius,this.radius*2,this.radius*2);
			}
			break;
